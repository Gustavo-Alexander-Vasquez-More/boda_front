...
export default function Index() {
  ...
  return (
    ...
    <div className='absolute top-[80%] left-[57%] flex gap-10'>
      <Anchor className='bg-[red] px-[0.7rem] py-[0.3rem] text-center text-white font-semibold rounded-[10px]'>Ingresar con música</Anchor>
      <Anchor to={'/templated'} className='bg-[red] px-[0.7rem] py-[0.3rem] text-center font-semibold text-white rounded-[10px]'>Ingresar sin música</Anchor>
    </div>
    </div>
    </div>
  );
