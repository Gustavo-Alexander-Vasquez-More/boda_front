...
export default function footer() {
  return (
    <div className='w-full  bg-[#4A663E] flex flex-col gap-4 items-center px-[1rem] text-white py-[2rem]'>
        <div className='flex flex-col items-center'>
            <p className='pacifico text-[2rem]'>Contáctame</p>
            <div className='flex'>
                <a target='_blank' href='https://wa.link/hjd5kt'>
                ...
                <a target='_blank' href='https://www.facebook.com/gustavoalex.vasquezmore/'>
                ...
                <a target='_blank' href='https://github.com/Gustavo-Alexander-Vasquez-More'>
                    <svg class="w-10 h-10 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a target='_blank' href='https://www.linkedin.com/in/gustavo-alexander-v%C3%A1squez-more-94b2b923a/'>
                    <svg class="w-10 h-10 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
