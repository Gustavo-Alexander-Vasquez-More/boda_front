...
export default function seccion_retratos() {
    const responsive = {
        desktop: {
  ...
  return (
    <div className='w-full h-screen  flex justify-center items-center bg-cover 'style={{ backgroundImage: `url(${background})` }}>
        ...
        <p className='text-[2.5rem] text-[#4A663E] font-bold calendar pacifico'>Retratos de nuestra historia</p>
        <p className='text-[1.5rem] text-[#8B9360]  calendar'>Un minuto, un segundo, un instante que queda en la eternidad</p>
        <CarouselMulti responsive={responsive} className="w-[40%] h-[60vh]" autoPlay infinite={true}>
