...
export default function seccion_dress_code({deslizar_reloj}) {
  return (
    <div className='w-full lg:h-screen h-auto flex flex-col py-[2rem] justify-center items-center bg-no-repeat bg-cover relative  bg-[url("https://png.pngtree.com/background/20230611/original/pngtree-wedding-ceremony-set-up-for-a-wedding-in-the-woods-picture-image_3154319.jpg")]'>
...
Queremos unir nuestras vidas delante de Dios y deseamos que seas testigo de este día tan especial para nosotros.
          ...
          <p className='text-[1rem] text-white font-semibold'>Sigue bajando</p>
      </button>
    </div>
  );
}
